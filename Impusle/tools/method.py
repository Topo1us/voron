...
class AttackMethod:
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        print(f"{Fore.MAGENTA}[!] {Fore.BLUE}{'Готово.'}{Fore.RESET}")
    ...
    def __RunThreads(self):
        ...
        # Start flood threads
        with Spinner(
            label=f"{Fore.YELLOW}{self.threads_count}{Fore.RESET}",
            total=100,
        ) as spinner:
        ...
        for index, thread in enumerate(self.threads):
            ...
            p=1
#            print(
#                f"{Fore.GREEN}{Fore.YELLOW}{Fore.RESET}"
#            )
    ...
    def Start(self):
        ...
        print(
            f"{Fore.MAGENTA}[?] {Fore.BLUE}началась атака на  {target} метод {self.name}.{Fore.RESET}\n"
            f"{Fore.MAGENTA}[?] {Fore.BLUE}до окончания атаки {Fore.MAGENTA}{duration}{Fore.BLUE}.{Fore.RESET}"
        )
